...
public partial class MessageViewModel : ViewModelBase<MessageComponent>
{
    [ObservableProperty]
    ...
    [ObservableProperty]
    private long _duration = 2000;

    // Element Plus message palette: light background + colored text/border.
